...
\makeatother
\hypersetup{
  pdftitle={Convergence Analysis of Gradient Descent Optimization},
...
\textbf{State:} unpublished / pending pairing

\textbf{Pairing:} pending --- unresolved: - ✗ GitHub release URL:
\texttt{pending} - ✗ PDF SHA-256: \texttt{pending}
...
GitHub & docxology/template\_code\_project \\
...
\href{https://github.com/docxology/template/blob/main/scripts/pipeline/stage_02_analysis.py}{analysis
...
\textbf{1.9 \texorpdfstring{\ensuremath{\mu}}{mu}s} (recorded in
...
\bottomrule\noalign{}
\endlastfoot
Config hash (SHA-256, truncated) & \breaktt{7182b437c586a680} \\
Paper version & 2.5.2 \\
...
Analysis reports & 19 \\
\textbf{Total artifacts} & \textbf{33} \\
\end{longtable}
}
...
\subsubsection{Benchmark Demonstration}\label{benchmark-demonstration}
...
SHA-256 \texttt{pending…} \texorpdfstring{\ensuremath{\cdot}}{.} pairing pending
