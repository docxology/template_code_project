...
uv run python scripts/pipeline/stage_03_render.py --project templates/template_code_project   # re-verify
```
...
**Symptom:** `scripts/pipeline/stage_01_test.py --project templates/template_code_project` prints
